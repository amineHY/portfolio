...
- Secteur d’activité: Information technologie et services

## Compétence clés

- Recherche et développement
- Préparation et analyse des données
- Définition du besoin métier et conseil sur la mise en place d’une solution technique
...
- Secteur d’intervention : Banque / Assurance, Ferroviaire, Industrie, Aéronautique & Spatiale
...
- Amélioration des KPI de l’application running de la montre _TAG Hueur Connected_
...
- Spatio-spectral reconstruction from multispectral data. Application to the Mid-Infrared instrument of the JWST

#### Description de la réalisation

- In charge of innovating a data processing solution for the JWST / NASA space telescope (14 countries, budget> $ 10 billion)
...
- [https://sci.esa.int/web/jwst/-/46826-miri-the-mid-infrared-instrument-on-jwst](https://sci.esa.int/web/jwst/-/46826-miri-the-mid-infrared-instrument-on-jwst)
...
### Publiés dans des conférence internationaux
